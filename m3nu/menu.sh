...
Port dropbear tidak boleh sama dengan port openVPN/openSSH/squid3 !!!"| boxes -d peek | lolcat
	...
	"Install OpenVpn")
	clear
	wget https://raw.githubusercontent.com/EraHitam/F3Luxo/master/m3nu/openvpn
	chmod +x openvpn
	./openvpn
	break
	;;
  "Download Client Ovpn")
   ...
   echo -e "\e[31m http://$MYIP:81/client.ovpn"
    ...
    ;;
    "Install Ocs_Panel")
    wget https://raw.githubusercontent.com/EraHitam/F3Luxo/master/m3nu/speedtestt_py
    chmod +x speedtestt_py
    ./speedtestt_py
    break
    ;;
    "Edit Banner SSH")
